...
final class timing {
    ...
    public static void main(String args[]) {
        /*int a = 12; // 12 last correct factorial, 34 returns 0
        long b = 20;//20 last correct factorial ,66 returns 0
        Integer c = 12;//12 last correct factorial, 34 returns 0
        float d = 34;// 34 last correct factorial, 35 returns infinity
        double e = 170;//171 returns infinity
    	...
    	System.out.println("daffy Test");
    	Stopwatch timer = new Stopwatch();
    	for(int i = 30; i <= 44; i++) {
    		timer.start();
    		System.out.println(daffy(i));
    		timer.stop();
    		System.out.println(timer);
    	}
    	
    	System.out.println("donald Test");
    	//Stopwatch timer = new Stopwatch();
    	for(int i = 30; i <= 44; i++) {
    		timer.start();
    		System.out.println(donald(i));
    		timer.stop();
    		System.out.println(timer);
    	}
    	
    	System.out.println("Mickey Test");
    	//Stopwatch timer = new Stopwatch();
    	for(int i = 1000; i <= 128000; i*=2) {
    		int[] arrayOfCharacters = randomarr(i);
    		timer.start();
    		mickey(arrayOfCharacters);
    		timer.stop();
    		System.out.println("Timer for Mickey: " + timer);
    		
    	}
    	System.out.println("Minnie Test");
    	for(int i = 1000; i <= 128000; i*=2) {
    		int[] arrayOfCharacters = randomarr(i);
    		timer.start();
    		minnie(arrayOfCharacters);
    		timer.stop();
    		System.out.println("Timer for Minnie: " + timer);
    	}
    	System.out.println("Goofy Test");
    	for(int i = 1000; i <= 128000; i*=2) {
    		int[] arrayOfCharacters = randomarr(i);
    		timer.start();
    		goofy(arrayOfCharacters);
    		timer.stop();
    		System.out.println("Timer for Goofy: " + timer);
  
    	}
    	System.out.println("Pluto Test");
    	for(int i = 1000; i <= 128000; i*=2) {
    		int[] arrayOfCharacters = randomarr(i);
    		timer.start();
    		pluto(arrayOfCharacters);
    		timer.stop();
    		System.out.println("Timer for Pluto: " + timer);
    	}
    	System.out.println("Gyro Test");
    	for(int i = 1000; i <= 128000; i*=2) {
    		int[] arrayOfCharacters = randomarr(i);
    		pluto(arrayOfCharacters);
    		timer.start();
    		gyro(arrayOfCharacters);
    		timer.stop();
    		System.out.println("Timer for Gyro:" + timer);
    	}
//    	System.out.println("fact(BigInt) Test");
    	for(int i = 1000; i <= 64000; i*=2) {
    		timer.start();
    		fact(BigInteger.valueOf((long) i));
    		timer.stop();
    		System.out.println(timer);
    	}
    }
